# Hi, I'm **Josephine Lopez**

🔗 [GitHub](https://github.com/Jlope677) | 🔗 [LinkedIn](https://www.linkedin.com/in/josephine-lopez-ab537662/)

I am passionate about **Cybersecurity, Cloud Infrastructure, and IT Systems Administration**.  
I continuously build **hands-on labs and documentation** to strengthen my skills in Azure, networking, identity management, and enterprise IT support.
...
- [Azure Virtual Machine Deployment](https://github.com/Jlope677/azure-basics)
...
# 🌐 Networking & System Administration Labs

## Networking
- [VPN Setup Lab](https://github.com/Jlope677/setting-up-a-VPN)

## Identity & Directory Services
- [Active Directory Configuration Lab](https://github.com/Jlope677/Active-Directory/blob/main/ActiveDirectory-Lab-Project-README.md)

## DNS & Name Resolution
- [DNS Records & Caching Lab](https://github.com/Jlope677/DNS/blob/main/DNS-Lab-README.md)

## File Sharing & Permissions
- [Network File Shares & Permissions Lab](https://github.com/Jlope677/Network-File-Shares-and-Permissions-/blob/main/File_Share_Permissions_Lab_README.md)
...
- [osTicket Installation & Prerequisites](https://github.com/Jlope677/osTicket-Setup)
...
These guides document troubleshooting steps and real-world support scenarios.

## Printer & Email Support

- [Add Printer – Public Guide](https://github.com/Jlope677/adding-a-printer-Public/blob/main/Printix_Public_README.md)
- [Add Printer – Internal Notes](https://github.com/Jlope677/adding-printers-and-checking-to-see-if-there-on-the-right-network/blob/main/printix_full_private.md)
- [Scan to Email/Fax – Public](https://github.com/Jlope677/scan-to-email-or-fax-public)
- [Scan to Email/Fax – Private](https://github.com/Jlope677/scan-to-email-or-fax-private-/blob/main/scan-email-fax-private%20(2).md)

## Adobe & Outlook Troubleshooting

- [Adobe Licensing Guide](https://github.com/Jlope677/Adobe-License/blob/main/Adobe-License-Guide.md)
...
- [Conditional Access Troubleshooting](https://github.com/Jlope677/conditional-access-issue-resolution/blob/main/MFA_Conditional_Access_Troubleshooting_README.md)
...
- [Challenge Write-ups](https://github.com/Jlope677/DoD-Cyber-Sentinel-Challenge)
